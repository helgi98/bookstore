...
public class BookCommentController {
    ...
    public PageResponseDTO<BookCommentDTO> getComments(@PathVariable("bookId") @NotNull Long bookId, @ParameterObject @NotNull @Valid PageRequestDTO request) {
        return bookCommentService.getBookComments(bookId, request);
    }

    @PostMapping("/{bookId}/comments")
    @ResponseStatus(HttpStatus.CREATED)
    public BookCommentDTO addComment(@PathVariable("bookId") @NotNull Long bookId, @RequestBody @NotNull BookCommentDTO.BookCommentRequest createCommentRequest) {
        return bookCommentService.addComment(bookId, createCommentRequest);
    }

    @PutMapping("/{bookId}/comments/{id}")
    public BookCommentDTO updateComment(@PathVariable("id") @NotNull String id, @RequestBody @NotNull BookCommentDTO.BookCommentRequest updateBookCommentRequest) {
